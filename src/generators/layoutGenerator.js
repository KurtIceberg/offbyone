...
function buildRecoveryLayoutPrompt(variables = {}) {
  const sections = [
    ...
    'Design: ' + compactText(variables.professional_design_guidance_markdown || variables.design_profile_markdown || '', 420),
    'Visuals: ' + compactText(variables.visual_assets_summary || '', 360),
    'Industry playbook: ' + compactText(variables.industry_playbook_markdown || variables.industry_playbook || '', 420),
    '',
    'Hard rules:',
